...
namespace Checkitsedo\Calendarize\Property\TypeConverter;

use Checkitsedo\Calendarize\Domain\Model\Request\DefaultBookingRequest;
...
class AbstractBookingRequest extends AbstractTypeConverter
{
     ...
     * @var string
     */
    protected $targetType = \Checkitsedo\Calendarize\Domain\Model\Request\AbstractBookingRequest::class;
     ...
     *
     * @return \Checkitsedo\Calendarize\Domain\Model\Request\AbstractBookingRequest
     */
